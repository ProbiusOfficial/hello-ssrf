...
<body>
    <div class="container">
        ...
        <div class="challenge-description">
            <h2>Level 2 | 开放了什么？</h2>
            <p>在 SSRF 中 DICT 协议常用于探测内网端口开放情况，"dict://ip:prot"当遇到开放端口时，响应速度会明显变慢，有的端口还会带 TCP 回显</p>
            <p>本关卡无任何过滤，使用Python查询模拟了 5 个端口的开放，Flag为每个开放端口的回显消息（端口均在10000以下）</p>
            <br>
            <p>.eg:尝试通过dict协议(dict://)来探测 dict://127.0.0.1:port</p>
        </div>
