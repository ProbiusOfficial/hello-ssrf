...
<body>
    <div class="container">
        ...
        <div class="challenge-description">
            <h2>Level 3 | Gopher's mirror </h2>
            <p>gopher 协议是一个古老且强大的协议，可以传递最底层的 TCP 数据流</p>
            <p>本关卡无任何过滤，Python将监听81端口，你对该端口发送的所有TCP信息都会被镜像返回。</p>
            <br>
            <p>.eg:尝试通过gopher协议(gopher://)来向81端口发送消,gopher://host:port/gopher-path_TCP数据流,gopher://127.0.0.1:81/_hello_world!</p>
        </div>
