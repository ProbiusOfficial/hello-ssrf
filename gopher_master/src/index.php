...
<body>
    <div class="container">
        ...
        <div class="challenge-description">
            <h2>Level 4 | Gopher Master </h2>
            <p>记得么，HTTP 协议也是属于 TCP 数据层的，所以Gopher可以完成POST操作</p>
            <p>你需要对原始POST请求完成下面加工：<br>1，移除Accept-Encoding: gzip, deflate <br>2，URL编码原始POST请求的所有字符</p>
            <p>本关卡无任何过滤，Python将监听81 8181端口，你需要分别用get和post发送key=helloctf的参数来获取flag</p>
            <br>
            <p>.eg:gopher://127.0.0.1:8181/_数据流 | 如果使用浏览器发送一次编码即可，如果是burp，请使用两次。</p>
        </div>
